...
async def migrate_real_wallet_schema() -> None:
    statements = [
        ...
        "ALTER TABLE real_autobuy_filters ADD COLUMN IF NOT EXISTS trailing_stop_enabled BOOLEAN DEFAULT FALSE",
        "ALTER TABLE real_autobuy_filters ADD COLUMN IF NOT EXISTS trailing_activation_pct FLOAT",
        "ALTER TABLE real_autobuy_filters ADD COLUMN IF NOT EXISTS trailing_pct FLOAT",
        "ALTER TABLE real_autobuy_filters ADD COLUMN IF NOT EXISTS trailing_initial_stop_loss_pct FLOAT",
        "ALTER TABLE real_autobuy_filters ADD COLUMN IF NOT EXISTS trailing_step_pct FLOAT",
        "ALTER TABLE real_autobuy_filters ADD COLUMN IF NOT EXISTS trailing_profit_tiers VARCHAR",
        """CREATE TABLE IF NOT EXISTS real_trailing_stops (
            ...
            trailing_step_pct FLOAT NOT NULL DEFAULT 0.0,
            profit_tiers_json TEXT,
            sell_fraction FLOAT NOT NULL DEFAULT 1.0,
        ...
        "CREATE INDEX IF NOT EXISTS ix_real_trailing_stops_user_id ON real_trailing_stops (user_id)",
        "CREATE INDEX IF NOT EXISTS ix_real_trailing_stops_trade_id ON real_trailing_stops (trade_id)",
        "CREATE INDEX IF NOT EXISTS ix_real_trailing_stops_status ON real_trailing_stops (status)",
